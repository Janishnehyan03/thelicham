...
function page() {
  ...
  <section className="py-4">
    <h2 className="text-2xl font-bold text-gray-800">Welcome to my blog!</h2>
  ...
  <section className="py-4">
    <h2 className="text-2xl font-bold text-gray-800">What I write about</h2>
    <p className="text-gray-600">
    ...
    <ul className="list-disc list-inside text-gray-600">
      ...
      <li className="leading-6 bg-gray-200 rounded-md shadow-sm">Science</li>
      <li className="leading-6 bg-gray-200 rounded-md shadow-sm">Culture</li>
      <li className="leading-6 bg-gray-200 rounded-md shadow-sm">
        Current events
      </li>
      <li className="leading-6 bg-gray-200 rounded-md shadow-sm">
  ...
  <section className="py-4">
    <h2 className="text-2xl font-bold text-gray-800">How to get in touch</h2>
